...
export const placeLikeBtnStyle = (liked) => ({ cursor: "pointer", fontSize: "12px", padding: "6px 14px", borderRadius: "20px", background: liked ? "#e8f5eb" : "#f0f0f0", color: liked ? "#2e6a4a" : "#888", fontWeight: "bold", transition: "0.2s", display: "flex", alignItems: "center", gap: "4px" });
...
export const swipeContainerStyle = { display: "flex", overflowX: "auto", width: "100vw", height: "100vh", scrollSnapType: "x mandatory" };
